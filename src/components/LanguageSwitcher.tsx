...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    join_supporter: "Join as Supporter",
  ...
  hi: {
    ...
    join_supporter: "समर्थक के रूप में जुड़ें",
    ngo_onboarding: "NGO पंजीकरण",
    apply_ngo: "NGO भागीदार के रूप में आवेदन करें",
  ...
  hinglish: {
    ...
    ngo_verified: "NGO Verified Hai",
    pay_upi: "UPI se Pay Karo",
    track_impact: "Impact Track Karo",
    join_supporter: "Support Karne aa jao",
    ngo_onboarding: "NGO Registration",
