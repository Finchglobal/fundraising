    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-green-950 text-green-100 flex flex-col border-r border-green-900 flex-shrink-0">
        ...
        <div className="p-4 border-t border-green-900">
           <LogoutLink className="flex items-center gap-3 px-3 py-2 rounded-lg text-green-400 hover:text-white hover:bg-green-900 transition-colors w-full text-left" />
        </div>
      </aside>
